    ...
    <>
      <MainContainer>
        <BlueContainer>
          ...
          <Text>
            With the use of knowledge of our creative team, we are able to
            create incredible advertising content for you.
          </Text>
          <Text>
            It’s designed to leave a good first impression witch will lead
            customers closer to buying your product.
          </Text>
          <Points src={points} />
        </BlueContainer>
        <ContentContainer>
