...
import {MainContainer,
    ...
    ArrowLeft,
    ArrowRight,
    Points} from './VisualisationStyled';
        ...
        <>
            <MainContainer>
                <BlueContainer>
                    ...
                    <Text>Is video advertasing  where we replace the real life products with 3D models, which will open new possibilities to us  in terms of video editing.</Text>
                    <Text>3D also enhances product quaility and creates better conditions for making representive video animation.</Text>
                    <Points src={points} />
                </BlueContainer>
                <ContentContainer>
                    <TitleDiv>
